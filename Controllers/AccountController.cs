...
namespace DDU.Controllers.Identity
{
        ...
        public async Task<IActionResult> Login(Login login)
        {
            if (ModelState.IsValid)
            {
                ...
                if (ApplicationUser != null)
                {
                    ...
                    Microsoft.AspNetCore.Identity.SignInResult result = await signInManager.PasswordSignInAsync(ApplicationUser, login.Password, login.Remember, false);
                    ...
                    {
                        return RedirectToAction("LoginTwoStep", new { ApplicationUser.Email, login.ReturnUrl });
                    }*/

                    // Uncomment Email confirmation https://www.yogihosting.com/aspnet-core-identity-email-confirmation/
                    /*bool emailStatus = await userManager.IsEmailConfirmedAsync(ApplicationUser);
